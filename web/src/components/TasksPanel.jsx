      ...
      <section className="rounded-2xl border border-border-light bg-surface-light p-5 shadow-card">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex min-h-[64px] min-w-[64px] flex-col items-center justify-center rounded-full bg-primary/10 px-2 py-2 text-center text-xs font-semibold leading-tight text-primary">
              <span>미완료</span>
